...
const PropertyGallery = ({ images }) => {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-[280px] md:h-[480px] bg-gray-200 rounded-xl flex items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="relative">
        {/* Main Image */}
        <div
          className="w-full h-[280px] md:h-[480px] bg-gray-200 rounded-xl overflow-hidden cursor-pointer"
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 mt-4">
          {images.slice(0, 6).map((image, index) => (
            <div
              ...
              className={`h-16 sm:h-24 bg-gray-200 rounded-lg overflow-hidden cursor-pointer border-2 transition ${
